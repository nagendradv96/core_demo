...
$id=$_REQUEST['id'];
$selq="select * from banquet_hall where id='$id'";
...
if(isset($_POST['submit']))
{
	 ...
	 if($image=='')
	 {
		 $q="UPDATE `banquet_hall` SET `title`='$title' where id=$id";
	 }
	 else
	 {
		 $q="UPDATE `banquet_hall` SET `title`='$title', `image`='$image' where id=$id"; 
	 }
