          ...
          <div class="box">            
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php $selq="select * from gallery where category='$category'";
                ...
                <tr>
                  ...
                  <td><a href="edit-gallery.php?id=<?php echo $sel_row['id']; ?>&cat=<?php echo $category ?> ">EDIT </a></td>
                  <td><a href="delete-gallery.php?id=<?php echo $sel_row['id']; ?>&cat=<?php echo $category ?> ">DELETE </a></td>
                </tr>
                <?php } ?>
                </tbody>
              </table>
