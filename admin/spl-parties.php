...
$q="UPDATE `spl_parties` SET `detail`='$detail',`mobile1`='$mobile1',`mobile2`='$mobile2' where id=1";	
    ...
    <div class="box box-warning">
        ...
        <form method="post" role="form">              
            <div class="form-group">                        
              ...
              <input type="text" name="detail" value="<?php echo $det; ?>" class="form-control" placeholder="Address ..." required=""><br>
